...
# mpirun -n 144 /path_to_your_executable/ramses3d ./params.nml > my_out.log
# Rename my_out.log if running more than one time (in most cases, the results have been obtained by averaging over 3 runs).
mpirun -n 144 /home/dc-ragt1/Ramses/ramses/bin/ramses_intelmpi3d ./params.nml > my_out.log
